							...
							<div class="purchase-complete-container">
								<div class="basket-container">
										...
										<c:if test="${not empty list }">
											<c:forEach var="i" items="${list }" varStatus="vs">
												<tr>
													...
													<td class="tbl-td"><span>${i['product_no']}</span></td>
													<td class="tbl-td"><span>${i["member_id"]}</span></td>
													<td class="tbl-td">
														<div id="tbl-img-row">
															<img
																src="${pageContext.request.contextPath }/resources/upload/productFile/${i['renamed_filename']}"
																alt="" width="auto" height="70px"> <span>&nbsp;
																[${i["brand_name"]}] &nbsp; ${i["product_name"]}</span>
														</div>
													</td>
									...
									<ul class="pagination justify-content-center pagination-sm"
										style="clear: both; margin-left: 140px;">
										<!-- 페이지바 -->
										<%
