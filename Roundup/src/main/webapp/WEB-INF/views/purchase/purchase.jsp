			    		...
			    		success:function(data) {
			    			...
			    			if(data==="success") {
			    				if(confirm("결제가 완료되었습니다. 결제 내역 페이지로 이동하시겠습니까?")) {
			    					// 결제내역 페이지 보여주기
			    					location.href="${pageContext.request.contextPath}/member/myPagePurchaseComplete.do?memberId=${member_id}"; 
			    				} else {
			    					// 장바구니 페이지 보여주기
			    					location.href="${pageContext.request.contextPath }/member/myPageBasket.do?memberId=${member_id}";
			    				} 
			    			}
			    		},
