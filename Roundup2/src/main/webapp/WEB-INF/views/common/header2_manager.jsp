                ...
                <ul class="nav-bar-site">
                    ...
                    <li class="nav-bar-site-li">
	                    <c:if test="${memberLoggedIn!=null}">
	                    	<a href="${pageContext.request.contextPath }/basket/selectBasketList.do?memberId=${memberLoggedIn.member_id}" style="color:black"></a>
	                    </c:if>
	                    <c:if test="${memberLoggedIn==null}">
	                    	<a id="cart" href='javascript:window.alert("로그인 후 이용하실 수 있습니다.");' style="color:rgb(255,0,102);">장바구니</a>
	                    </c:if>
                    ...
                    <c:if test="${memberLoggedIn==null}">
	                    	<a href='javascript:window.alert("로그인 후 이용하실 수 있습니다.");' style="color:rgb(255,0,102);">마이페이지</a>
	                    </c:if>
	                 <!-- 고객센터 사라질 수 있음. -->
                    <li class="nav-bar-site-li"><a href="#">고객센터</a></li>
